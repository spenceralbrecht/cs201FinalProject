...
<div id="mySidenav" class="sidenav">
    <img id="avatar" src="https://www.w3schools.com/howto/img_avatar.png"
         width="100" height="100" /> <a id="name" href="profile.jsp"><%=request.getSession().getAttribute("username") %></a>
    <span id="projectDirection"></span> <form action="createProject.jsp" method="POST" class="form create project">
